...
const useProposedWallFabricDetailsStore = create(
  persist(
    (set) => ({
    ...
    {
      name: 'proposed-wall-fabric-details-storage', // Unique name for storage key
    }
  )
);

export default useProposedWallFabricDetailsStore;