...
export function calculateWallHeatLoss(uaValue) {
  // Make sure we're working with a numeric value
  const numericUAValue = parseFloat(uaValue) || 0;
  return numericUAValue;
}

export function calculateTotalFabricHeatLoss(roofHeatLoss, wallUAValue, slabUAValue, windowUAValue, doorUAValue) {
