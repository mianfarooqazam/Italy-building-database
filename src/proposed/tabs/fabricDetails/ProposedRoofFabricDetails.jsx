...
function ProposedRoofFabricDetails() {
  // Get floor plan data from useFloorPlanStore
  const {
    totalFloorArea,
  } = useFloorPlanStore();
  const { totalFabricHeatLoss, setRoofHeatLoss: setGlobalRoofHeatLoss } = useTotalFabricHeatLossStore();
  ...
  const [localOuterLayerMaterial, setLocalOuterLayerMaterial] = useState(outerLayerMaterial);
  const [localOuterLayerThickness, setLocalOuterLayerThickness] = useState(outerLayerThickness);
  const [localCoreLayerMaterial, setLocalCoreLayerMaterial] = useState(coreLayerMaterial);
  const [localCoreLayerThickness, setLocalCoreLayerThickness] = useState(coreLayerThickness);
  const [localInsulationLayerMaterial, setLocalInsulationLayerMaterial] = useState(insulationLayerMaterial);
  const [localInsulationLayerThickness, setLocalInsulationLayerThickness] = useState(insulationLayerThickness);
  const [localInnerLayerMaterial, setLocalInnerLayerMaterial] = useState(innerLayerMaterial);
  const [localInnerLayerThickness, setLocalInnerLayerThickness] = useState(innerLayerThickness);
  ...
  const { layers, rValues, kappaValues } = useMemo(() => {
    ...
    processLayer(localOuterLayerMaterial, localOuterLayerThickness, 'Outer Layer');
    processLayer(localCoreLayerMaterial, localCoreLayerThickness, 'Core Layer');
    processLayer(localInsulationLayerMaterial, localInsulationLayerThickness, 'Insulation Layer');
    processLayer(localInnerLayerMaterial, localInnerLayerThickness, 'Inner Layer');
  ...
  useEffect(() => {
    if (layers.length > 0) {
      try {
        ...
        setLocalRoofHeatLoss(roofHeatLossValue.toFixed(3));
  ...
  return (
    <Box p={3} display="flex" flexDirection="row" gap={2}>
      ...
      <Box width="80%" display="flex" flexDirection="column" gap={2}>
        ...
        <Box display="flex" gap={2} alignItems="center">
          <FormControl fullWidth variant="outlined">
            ...
            <Select
              label="Outer Layer"
              value={localOuterLayerMaterial ? localOuterLayerMaterial.name : ''}
              onChange={(e) => {
          ...
          <TextField
            ...
            disabled={localOuterLayerMaterial && localOuterLayerMaterial.name === 'None'}
          />
        </Box>
        ...
        <Box display="flex" gap={2} alignItems="center">
          ...
          <TextField
            ...
            disabled={localCoreLayerMaterial && localCoreLayerMaterial.name === 'None'}
          />
        </Box>
        ...
        <Box display="flex" gap={2} alignItems="center">
          <FormControl fullWidth variant="outlined">
            ...
            <Select
              ...
              value={localInsulationLayerMaterial ? localInsulationLayerMaterial.name : ''}
              onChange={(e) => {
          ...
          <TextField
            ...
            disabled={localInsulationLayerMaterial && localInsulationLayerMaterial.name === 'None'}
          />
        </Box>
        ...
        <Box display="flex" gap={2} alignItems="center">
          <FormControl fullWidth variant="outlined">
            ...
            <Select
              label="Inner Layer"
              value={localInnerLayerMaterial ? localInnerLayerMaterial.name : ''}
              onChange={(e) => {
          ...
          <TextField
            ...
            disabled={localInnerLayerMaterial && localInnerLayerMaterial.name === 'None'}
          />
        </Box>
      ...
      <Box width="20%" display="flex" flexDirection="column" gap={2}>
        ...
        R-Value: {rTotal || '0.000'}</Typography>
        </Box>
        ...
        {/* Kappa Value Display */}
        <Box p={2} bgcolor="#D9EAFD" borderRadius={2} textAlign="center">
          <Typography variant="body2" fontWeight="bold">Kappa Value: {localKappaValue}</Typography>
        </Box>

        {/* Roof Area Display */}
        <Box p={2} bgcolor="#D9EAFD" borderRadius={2} textAlign="center">
          <Typography variant="body2" fontWeight="bold">Roof Area (m²):  {(parseFloat(totalFloorArea || 0) * 0.092903).toFixed(2) || '0.00'}</Typography>
        ...
        <Box p={2} bgcolor="#D9EAFD" borderRadius={2} textAlign="center">
          <Typography variant="body2" fontWeight="bold">Roof Heat Loss: {localRoofHeatLoss}</Typography>
        </Box>
...
export default ProposedRoofFabricDetails;