                ...
                <TableBody>
                  {localWindows.map((window, index) => (
                    <TableRow key={index}>
                      ...
                      <TableCell  sx={{textAlign:"center"}}>{window.area.toFixed(2)}</TableCell>
        ...
        <TableBody>
          {localDoors.map((door, index) => (
            <TableRow key={index}>
              ...
              <TableCell  sx={{textAlign:"center"}}>{door.area.toFixed(2)}</TableCell>
              <TableCell sx={{textAlign:"center"}}>
                <IconButton
                  color="error"
                ...
                <TableRow>
                  <TableCell>
                    ...
                    !isNaN(localTotalFloorArea)
                      ? `${localTotalFloorArea.toFixed(2)} ft²`
                      : "N/A"}
                  </TableCell>
                  <TableCell>
                    {typeof localTotalFloorArea === "number" &&
