...
import useWindowFabricDetailsStore from "../../store/proposed/useProposedWindowFabricDetailsStore.js";
import useLightingStore from "../../store/proposed/useProposedLightingStore.js";
import useSolarGainStore from "../../store/proposed/useProposedSolarGainStore.js";
...
const ProposedSolarGainCalculation = () => {
            ...
            {months.map((month) => {
              ...
              return (
                <TableRow key={month}>
                  ...
                  <TableCell align="right">{eValue.toFixed(5)}</TableCell>
                  <TableCell align="right">{gainsW.toFixed(5)}</TableCell>
                  <TableCell align="right">{occupantMetabolic.toFixed(5)}</TableCell>
                  <TableCell align="right">{occupantCooking.toFixed(5)}</TableCell>
                  <TableCell align="right">{totalIntGains.toFixed(5)}</TableCell>
                </TableRow>
              );
            })}
          </TableBody>
            ...
            {months.map((month) => {
              ...
              return (
                <TableRow key={month}>
                  ...
                  <TableCell align="right">{solar.toFixed(5)}</TableCell>
                  <TableCell align="right">{internal.toFixed(5)}</TableCell>
...
export default ProposedSolarGainCalculation;